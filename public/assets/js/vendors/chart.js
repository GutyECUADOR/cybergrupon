    ...
    (function () {
        ...
        $("#earning").length &&
            ((e = {
                ...
                xaxis: { axisBorder: { show: !1 }, axisTicks: { show: !1 }, crosshairs: { show: !0 }, labels: { offsetX: 0, offsetY: 5, style: { fontSize: "13px", fontWeight: 400, cssClass: "apexcharts-xaxis-label" } } },
                yaxis: {
                    labels: {
                ...
                grid: { borderColor: window.theme.borderColor, strokeDashArray: 5, xaxis: { lines: { show: !1 } }, yaxis: { lines: { show: !0 } }, padding: { top: 0, right: 0, bottom: 0, left: 0 } },
                legend: {
                    position: "top",
                    horizontalAlign: "right",
                    offsetY: -50,
                    fontSize: "16px",
                    markers: { width: 10, height: 10, strokeWidth: 0, strokeColor: window.theme.white, fillColors: void 0, radius: 12, onClick: void 0, offsetX: 0, offsetY: 0 },
                ...
                ((e = {
                    ...
                    yaxis: {
                        labels: {
                            ...
                            style: { fontSize: "13px", fontWeight: 400, colors: [window.theme.primary] },
                            offsetX: -15,
                        },
                        tickAmount: 3,
                        min: 10,
                ...
                ((e = {
                    ...
                    yaxis: {
                        labels: {
                            ...
                            style: { fontSize: "13px", fontWeight: 400, colors: [window.theme.gray500] },
                            offsetX: -20,
                        },
                        tickAmount: 3,
                        min: 0,
                    ...
                    grid: { borderColor: window.theme.borderColor, strokeDashArray: 5, xaxis: { lines: { show: !1 } }, yaxis: { lines: { show: !0 } }, padding: { top: 0, right: 0, bottom: 0, left: -10 } },
                    legend: {
                        position: "top",
                        horizontalAlign: "right",
                        offsetY: -50,
            ...
            $("#traffic").length &&
                ((e = {
                    ...
                    legend: {
                        ...
                        fontWeight: 500,
                        fontSize: "14px",
                        markers: { width: 8, height: 8, strokeWidth: 0, strokeColor: window.theme.white, fillColors: void 0, radius: 12, customHTML: void 0, onClick: void 0, offsetX: 0, offsetY: 0 },
            ...
            $("#orderColumn").length &&
                ((e = {
                    ...
                    grid: { borderColor: window.theme.borderColor, strokeDashArray: 5, xaxis: { lines: { show: !1 } } },
                    xaxis: {
                        categories: ["1 Jun", "9 Jun", "16 Jun", "18 Jun", "19 Jun", "22 Jun", "24 Jun", "26 Jun"],
                        axisBorder: { show: !1 },
                        labels: { offsetX: 0, offsetY: 5, style: { fontSize: "14px", fontWeight: 400, colors: window.theme.gray500 } },
                    },
                    grid: { borderColor: window.theme.borderColor, strokeDashArray: 5, xaxis: { lines: { show: !1 } }, yaxis: { lines: { show: !0 } }, padding: { top: 0, right: 0, bottom: 0, left: -10 } },
            ...
            $("#totalEarning").length &&
                ((e = {
                    ...
                    tooltip: { enabled: !1 },
                    stroke: { show: !0, curve: "smooth", lineCap: "butt", colors: [window.theme.success], width: 2, dashArray: 0 },
                    grid: { show: !1 },
                    yaxis: { labels: { show: !1 } },
            ...
            $("#payoutChart").length &&
                ((e = {
                    ...
                    dataLabels: { enabled: !1 },
                    xaxis: { labels: { show: !1 }, categories: [], position: "top", axisBorder: { show: !1 }, axisTicks: { show: !1 }, tooltip: { enabled: !0 } },
                    yaxis: { show: !1 },
                }),
            ...
            $("#userChartExample").length &&
                ((e = {
                    chart: { height: 60, type: "area", toolbar: { show: !1 }, sparkline: { enabled: !0 }, grid: { show: !1, padding: { left: 0, right: 0 } } },
                    colors: [window.theme.danger],
                    dataLabels: { enabled: !1 },
                    stroke: { curve: "smooth", width: 2 },
                    fill: { type: "gradient", gradient: { gradientToColors: [window.theme.danger], shadeIntensity: 0.7, opacityFrom: 0.5, opacityTo: 0.04, stops: [0, 80, 100] } },
                    series: [{ name: "User", data: [28, 40, 36, 52, 38, 60, 55] }],
                    xaxis: { labels: { show: !1 }, axisBorder: { show: !1 } },
                    yaxis: [{ y: 0, offsetX: 0, offsetY: 0, padding: { left: 0, right: 0 } }],
                    tooltip: { x: { show: !1 } },
            ...
            $("#userChart").length &&
                ((e = {
                    ...
                    dataLabels: { enabled: !1 },
                    stroke: { curve: "smooth", width: 2 },
                    fill: { colors: [window.theme.success], type: "gradient", gradient: { type: "vertical", gradientToColors: [window.theme.success], shadeIntensity: 0.7, opacityFrom: 0.5, opacityTo: 0.04, stops: [0, 80, 100] } },
                    series: [{ name: "User", data: [28, 40, 36, 52, 38, 60, 55] }],
                    xaxis: { labels: { show: !1 }, axisBorder: { show: !1 } },
                    yaxis: [{ y: 0, offsetX: 0, offsetY: 0, padding: { left: 0, right: 0 } }],
                    tooltip: { x: { show: !1 } },
            ...
            $("#sessionChart").length &&
                ((e = {
                    series: [
                        { name: "Session Duration", data: [600, 1e3, 400, 2e3, 500, 900, 2500, 1800, 3800], colors: [window.theme.primary] },
                    ...
                    xaxis: {
                        ...
                        labels: { style: { fontSize: "12px", fontFamily: "Inter", cssClass: "apexcharts-xaxis-label", colors: window.theme.gray500 } },
                        axisBorder: { show: !0, color: window.theme.borderColor, height: 0, width: "100%", offsetX: 0, offsetY: 0 },
                        axisTicks: { show: !0, borderType: "solid", color: window.theme.borderColor, height: 6, offsetX: 0, offsetY: 0 },
                    },
            ...
            $("#locationmap").length &&
                new jsVectorMap({
                    ...
                    markerLabelStyle: { initial: { fontFamily: "Inter", fontSize: 13, fontWeight: 500, cursor: "default", fill: [window.theme.dark] } },
                    labels: { markers: { render: (e) => e.name } },
                }),
            $("#trafficDountChart").length &&
                ((e = {
                    series: [60, 55, 12, 17],
            ...
            $("#operatingSystem").length &&
                ((e = {
                    ...
                    plotOptions: {
                        polarArea: {
                            rings: { strokeWidth: 1, strokeColor: [window.theme.borderColor] },
                            spokes: { strokeWidth: 1, connectorColors: [window.theme.borderColor, window.theme.borderColor, window.theme.borderColor, window.theme.borderColor] },
                        },
                    },
                }),
                            ...
                            donut: {
                                ...
                                labels: {
                                    ...
                                    total: {
                                        ...
                                        fontWeight: "600",
                                        formatter: function (e) {
                                            return "$" + e.globals.seriesTotals.reduce((e, o) => e + o, 0);
                                        },
                                    },
                                },
                            },
            ...
            $("#taskSummary").length &&
                ((e = {
                    series: [
                        { name: "Closed", type: "column", data: [12, 18, 20, 32, 19, 25, 30] },
                    ...
                    xaxis: {
                        labels: { style: { fontSize: "13px", fontWeight: 400, colors: window.theme.gray500, fontFamily: "inter" } },
                        axisBorder: { show: !0, color: window.theme.borderColor, height: 0, width: "100%", offsetX: 0, offsetY: 0 },
                        axisTicks: { show: !0, borderType: "solid", color: window.theme.borderColor, height: 6, offsetX: 0, offsetY: 0 },
                    },
            ...
            $("#budgetExpenseChart").length &&
                ((e = {
                    ...
                    plotOptions: { radar: { size: 150, offsetX: 0, offsetY: 0, polygons: { strokeColors: window.theme.borderColor, strokeWidth: 1, connectorColors: window.theme.borderColor, fill: { colors: void 0 } } } },
                    xaxis: {
                        categories: ["Design", "SaaS Services", "Development", "SEO", "Entertainment", "Marketing"],
                        labels: {
                            show: !0,
                            style: { colors: [window.theme.gray400, window.theme.gray400, window.theme.gray400, window.theme.gray400, window.theme.gray400, window.theme.gray400], fontSize: "14px", fontFamily: "Inter", fontWeight: 600 },
                        },
                    },
                }),
                new ApexCharts(document.querySelector("#budgetExpenseChart"), e).render()),
            $(".taskWireframeChart").length &&
                ((e = {
                    series: [65],
                    chart: { height: 40, width: 40, type: "radialBar" },
                    grid: { show: !1, padding: { left: -15, right: -15, top: -12, bottom: -15 } },
                    colors: [window.theme.success],
                    plotOptions: { radialBar: { hollow: { size: "30%" }, dataLabels: { showOn: "always", name: { show: !0, fontSize: "11px", fontFamily: void 0, fontWeight: 600, color: void 0, offsetY: 4 }, value: { show: !1 } } } },
                    stroke: { lineCap: "round" },
                    labels: ["65%"],
                }),
                new ApexCharts(document.querySelector(".taskWireframeChart"), e).render()),
            $(".taskPrototypeChart").length &&
                ((e = {
                    series: [75],
                    chart: { height: 40, width: 40, type: "radialBar" },
                    grid: { show: !1, padding: { left: -15, right: -15, top: -12, bottom: -15 } },
            ...
            $("#taskStatus").length &&
                ((e = {
                    ...
                    legend: {
                        ...
                        fontWeight: 500,
                        fontSize: "14px",
                        markers: { width: 8, height: 8, strokeWidth: 0, strokeColor: window.theme.white, fillColors: void 0, radius: 12, customHTML: void 0, onClick: void 0, offsetX: -2, offsetY: 1 },
                        itemMargin: { horizontal: 8, vertical: 0 },
                    },
                    tooltip: { theme: "light", marker: { show: !0 }, x: { show: !1 } },
                    states: { hover: { filter: { type: "none" } } },
                ...
                ((e = {
                    ...
                    plotOptions: {
                        radialBar: {
                            startAngle: -135,
                            endAngle: 225,
                            hollow: { margin: 0, size: "70%", background: window.theme.white, image: void 0, imageOffsetX: 0, imageOffsetY: 0, position: "front", dropShadow: { enabled: !0, top: 3, left: 0, blur: 4, opacity: 0.24 } },
                            track: { background: window.theme.white, strokeWidth: "67%", margin: 0, dropShadow: { enabled: !0, top: -3, left: 0, blur: 4, opacity: 0.35 } },
                            dataLabels: {
                                showOn: "always",
                                name: { show: !1 },
                                value: {
                    ...
                    fill: { type: "gradient", gradient: { shade: "dark", type: "horizontal", shadeIntensity: 0.5, gradientToColors: [window.theme.warning], inverseColors: !1, opacityFrom: 1, opacityTo: 1, stops: [0, 100] } },
                    stroke: { lineCap: "round" },
                }),
            ...
            $(".resultChart").length &&
                ((e = {
                    ...
                    plotOptions: {
                        radialBar: {
                            hollow: { margin: -2, size: "50%", background: [window.theme.lightSuccess] },
                            dataLabels: { showOn: "always", name: { show: !0, fontSize: "20px", fontFamily: void 0, fontWeight: 600, color: void 0, offsetY: 7 }, value: { show: !1 } },
                        },
                    },
                    stroke: { lineCap: "round" },
                    labels: ["85%"],

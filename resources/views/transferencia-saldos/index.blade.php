                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="border-bottom pb-3 mb-3">
                            <div class="mb-2 mb-lg-0">
                                <h1 class="mb-0 h2 fw-bold"> Transferencia de Saldos  </h1>
                                <!-- Breadcrumb -->
                                    ...
                                    <div class="bs-stepper-header p-0 bg-transparent" role="tablist">
                                        <div class="step" data-target="#test-l-1">
                                            <button type="button" class="step-trigger" role="tab"
                                                ...
                                                <span class="bs-stepper-label">Información de transferencia</span>
                                            </button>
                                        </div>
                                ...
                                <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('transferencia.store') }}">
                                            ...
                                            <div id="test-l-1" role="tabpanel" class="bs-stepper-pane fade"
                                                ...
                                                <!-- heading -->
                                                <div class="mb-5">
                                                    <h3 class="mb-1">Información de Transferencia</h3>
                                                ...
                                                <div class="row gx-3">
                                                    ...
                                                    <div class="mb-3 col-12">
                                                      <label class="form-label" for="wallet">Nickname (Que recibirá los fondos)</label>
                                                      <input type="text" class="form-control text-dark" placeholder="Ejemplo: Manito2023" name="nickname" id="nickname">
                                                    </div>
                                                     <!-- input -->
                                                    <div class="mb-3 col-12">
                                                        <label class="form-label" for="wallet">Valor a enviar</label>

...
<body class="bg-white">
    ...
    <main>
                    ...
                    <div class="col-lg-6 col-12">
                        <div>
                            <div class=" text-center text-md-start ">
                                <!-- heading -->
                                <h1 class=" display-2 fw-bold  mb-3">Bienvenido a Cybergrupon.com</h1>
                                <!-- lead -->
                                <p class="lead">El punto de encuentro de los emprendedores más existosos del mundo.</p>
                            </div>
                            <div class="mt-8">
                                <!-- card -->
                ...
                <div class="row">
                    <div class="offset-xl-2 col-xl-8 col-md-12 col-12">
                        <div class=" text-center mb-8">
                            ...
                            <span class="text-uppercase text-primary fw-semibold ls-md">Latest Job Opening</span>
                            <!-- heading -->
                                ...
                                <div>
                                    <div class="d-md-flex">
                                        <div class="mb-3 mb-md-0">
                                            <!-- Img -->
                                            <img src="./assets/images/job/job-brand-logo/job-list-logo-1.svg" alt="Geeks UI - Bootstrap 5 Template" class="icon-shape border rounded-circle">
                                        </div>
                                        <!-- text -->
                                        <div class="ms-md-3 w-100 mt-3 mt-xl-1">
                                            <div class="d-flex justify-content-between mb-5">
                                                <div>
                                                    <!-- heading -->
                                                    <h3 class="mb-1 fs-4"><a href="../jobs/job-single.html" class="text-inherit">Software Engineer
                                                            (Web3/Crypto)</a>
                                ...
                                <div>
                                    <div class="d-md-flex">
                                        <div class="mb-3 mb-md-0">
                                            ...
                                            <img src="./assets/images/job/job-brand-logo/job-list-logo-2.svg" alt="Geeks Bootstrap 5 Template" class="icon-shape border rounded-circle">
                                        </div>
                                        <!-- text -->
                                        <div class="ms-md-3  w-100 mt-3 mt-xl-1">
                                            <div class="d-flex justify-content-between mb-4">
                                                <div>
                                                    <h3 class="mb-1 fs-4"><a href="../jobs/job-single.html" class="text-inherit">Senior React
                                                            Developer</a> </h3>
                                                    <div>
                                            ...
                                            <div class="d-md-flex justify-content-between ">
                                                <div class="mb-2 mb-lg-0">
                                                    <!-- year -->
                                                    <span class="me-2"> <i class="fe fe-briefcase text-muted"></i><span class="ms-1 ">0 - 5
                                                            years</span></span>
                                                    <!-- salary -->
                                                    <span class="me-2">
                                                        <i class="fe fe-dollar-sign text-muted"></i><span class="ms-1 ">5k - 8k</span></span>
                                                    <!-- location -->
                                                    <span class="me-2">
                                                        <i class="fe fe-map-pin text-muted"></i><span class="ms-1 ">Jaipur, Rajasthan</span></span>
                                                </div>
                                                <!-- day -->
                                                <div>
                                                    <i class="fe fe-clock text-muted"></i> <span>1 day ago</span>
                                                </div>
                                            </div>
                                ...
                                <div>
                                    <div class="d-md-flex">
                                        <div class="mb-3 mb-md-0">
                                            ...
                                            <img src="./assets/images/job/job-brand-logo/job-list-logo-3.svg" alt="" class="icon-shape border rounded-circle">
                                        </div>
                                        <!-- text -->
                                        <div class="ms-md-3  w-100 mt-3 mt-xl-1">
                                            <div class="d-flex justify-content-between mb-4">
                                            ...
                                            <div>
                                                <div class="d-md-flex justify-content-between ">
                                                    <div class="mb-2 mb-md-0">
                                                        <!-- year -->
                                                        <span class="me-2"> <i class="fe fe-briefcase text-muted"></i><span class="ms-1 ">2 - 6
                                                                years</span></span>
                                                        <!-- year -->
                                                        <span class="me-2">
                                                            <i class="fe fe-dollar-sign text-muted"></i><span class="ms-1 ">Not discloses</span></span>
                                                        <!-- location -->
                                                        <span class="me-2">
                                                            <i class="fe fe-map-pin text-muted"></i><span class="ms-1 ">Hastsal, Delhi</span></span>
                                                    </div>
                                                    <div>
                                                        <!-- icon -->
                                                        <i class="fe fe-clock text-muted"></i> <span>1 day ago</span>
                                ...
                                <div>
                                    <div class="d-md-flex">
                                        <div class="mb-3 mb-md-0">
                                            ...
                                            <img src="./assets/images/job/job-brand-logo/job-list-logo-4.svg" alt="" class="icon-shape border rounded-circle">
                                        </div>
                                        <!-- text -->
                                        <div class="ms-md-3  w-100 mt-3 mt-xl-1">
                                            <div class="d-flex justify-content-between mb-4">
                                                <div>
                                                    <!-- heading -->
                                                    <h3 class="mb-1 fs-4"><a href="../jobs/job-single.html" class="text-inherit">Lead Software
                                                            Engineer</a> </h3>
                                                    <div>
                                                        <span>at Dot </span>
                                                        <!-- star -->
                                            ...
                                            <div>
                                                <div class="d-md-flex justify-content-between ">
                                                    <div class="mb-2 mb-md-0">
                                                        <!-- year -->
                                                        <span class="me-2"> <i class="fe fe-briefcase text-muted"></i><span class="ms-1 ">0 - 2
                                                                years</span></span>
                                                        <span class="me-2">
                                                            <!-- salary -->
                                                            <i class="fe fe-dollar-sign text-muted"></i><span class="ms-1 ">Not discloses</span></span>
                                                        <span class="me-2">
                                                            <!-- location -->
                                                            <i class="fe fe-map-pin text-muted"></i><span class="ms-1 ">Pune, Chennai</span></span>
                                                    </div>
                                                    <div>
                                                        <!-- time -->
                                                        <i class="fe fe-clock text-muted"></i> <span>1 Month ago</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div class="d-md-flex">
                                        <div class="mb-3 mb-md-0">
                                            ...
                                            <img src="./assets/images/job/job-brand-logo/job-list-logo-5.svg" alt="" class="icon-shape border rounded-circle">
                                        </div>
                                        <!-- text -->
                                        <div class="ms-md-3  w-100 mt-3 mt-xl-1">
                                            <div class="d-flex justify-content-between mb-4">
                                                <div>
                                                    <!-- heading -->
                                                    <h3 class="mb-1 fs-4"><a href="../jobs/job-single.html" class="text-inherit">Senior Full Stack
                                                            Engineer</a> </h3>
                                                    <div>
                                                        <span>at Toggle </span>
                                            ...
                                            <div>
                                                <div class="d-md-flex justify-content-between ">
                                                    ...
                                                    <div>
                                                        <!-- time -->
                                                        <i class="fe fe-clock text-muted"></i> <span>2 Month ago</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="offset-xl-1 col-xl-10 col-md-12 col-12">
                        <div class="row text-center">
                            ...
                            <div class="col-md-12 px-lg-10 mb-8 mt-6">
                                <span class="text-uppercase text-primary fw-semibold ls-md">Process</span>
                                <!-- heading -->
                        ...
                        <div class="row gy-6">
                            ...
                            <div class="col-md-4 col-12">
                                <div class=" text-center">
                                    ...
                                    <p class="mb-0 px-2">The base price for a job listing on Geeks is
        ...
        <section class="py-lg-16 bg-white pt-8 pb-10">
            <!-- container -->
                    ...
                    <div class="offset-xl-1 col-xl-10 col-md-12 col-12">
                        <div class="row text-center">
                            ...
                            <div class="col-md-12 px-md-16 mb-8 mt-6">
                                <span class="text-uppercase text-primary fw-semibold ls-md">Customer stories
                                </span>
                                <!-- heading -->

                                <h2 class="h1 fw-bold mt-3  mb-2">What our customer stories
                                </h2>
                                <!-- text -->

                                <p class="mb-0 fs-4">A customer story is an engaging article integrating testimonial quotes
                                    from a happy
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-7 col-md-12 col-12">
                                <div class="mb-8 mb-lg-0 me-lg-4">
                                    ...
                                    <p class="display-6 mb-4 lh-2">"Geeksjobs Welcome has helped us
                                        achieve continuity to ensure that all of our
                                        employees are on the same page."</p>
                                    <!-- text -->

                                    <p class="mb-0 ">David Stokes</p>
                                    <span class="">Program Manager at Company</span>
                                </div>
                            ...
                            <div class="col-lg-5 col-md-12 col-12">
                                <div>
                                    ...
                                    <img src="./assets/images/background/case-study-img-1.jpg" alt="case-study" class="img-fluid rounded-3 w-100">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="offset-xl-1 col-xl-10 col-md-12 col-12">
                        ...
                        <div class="row text-center">
                            <div class="col-md-12 px-lg-10 mb-8 mt-6">
                                ...
                                <span class="text-uppercase text-primary fw-semibold ls-md">Top Companies Hiring
                                </span>
                                <!-- heading -->
                        ...
                        <div class="row gy-4">
                            <div class="col-lg-3 col-md-6 col-12">
                                ...
                                <div class="card card-bordered card-hover  ">
                                    ...
                                    <div class="card-body">
                                        <img src="./assets/images/job/job-company-logo-a.svg" alt="company">
                                        <div class="my-4">
                                            <!-- heading -->
                                        ...
                                        <p class="mb-0"><span class="fw-semibold text-dark">424+</span> Job Posting</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-12">
                                ...
                                <div class="card card-bordered card-hover  ">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <img src="./assets/images/job/job-company-logo-g.svg" alt="company">
                                        <div class="my-4">
                                            <!-- heading -->
                                        ...
                                        <p class="mb-0"><span class="fw-semibold text-dark">216+ </span> Job Posting</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-12">
                                ...
                                <div class="card card-bordered card-hover  ">
                                    ...
                                    <div class="card-body">
                                        <img src="./assets/images/job/job-company-logo-l.svg" alt="company">
                                        <div class="my-4">
                                            <!-- heading -->
                                        ...
                                        <!-- text -->
                                        <p class="mb-0"><span class="fw-semibold text-dark">195+ </span> Job Posting</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-12">
                                ...
                                <div class="card card-bordered card-hover">
                                    ...
                                    <div class="card-body">
                                        <!-- Img -->
                                        <img src="./assets/images/job/job-company-logo-p.svg" alt="company">
                                        <div class="my-4">
                                            <!-- heading -->
                                        ...
                                        <!-- text -->
                                        <p class="mb-0"><span class="fw-semibold text-dark">180+ </span> Job Posting</p>
                                    </div>
                                </div>
                            </div>
                            <!-- button -->

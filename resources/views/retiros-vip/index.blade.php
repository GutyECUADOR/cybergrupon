                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="border-bottom pb-3 mb-3">
                            <div class="mb-2 mb-lg-0">
                                <h1 class="mb-0 h2 fw-bold"> Retiros VIP  </h1>
                                <!-- Breadcrumb -->
                        ...
                        <div id="stepperForm" class="bs-stepper">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('retiros-vip.store') }}">
                                            @csrf
                                            ...
                                            <div id="test-l-1" role="tabpanel" class="bs-stepper-pane fade"
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <p class="mb-0">Indique a continuación la información para el retiro. Pagos vip en USDT red TRX - TRC20
                                                    </p>
                                                    </p>
                                                    <p class="mb-0 text-danger">El valor minimo de retiro VIP es de 1000 USDT.
                                                    </p>
                                                    </p>
